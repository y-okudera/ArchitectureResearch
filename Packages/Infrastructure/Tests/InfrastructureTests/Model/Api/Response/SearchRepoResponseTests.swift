...
final class SearchRepoResponseTests: XCTestCase {
    ...
    func testInit() throws {
        ...
        XCTAssertEqual(responseObject.items.count, 1)
        XCTAssertEqual(responseObject.items[0].id, 44838949)
        XCTAssertEqual(responseObject.items[0].fullName, "apple/swift")
        XCTAssertEqual(responseObject.items[0].description, "The Swift Programming Language")
        XCTAssertEqual(responseObject.items[0].stargazersCount, 60300)
        XCTAssertEqual(responseObject.items[0].language, "C++")
        XCTAssertEqual(responseObject.items[0].htmlUrl, URL(string: "https://github.com/apple/swift")!)
        XCTAssertEqual(responseObject.items[0].owner.id, 10639145)
        XCTAssertEqual(responseObject.items[0].owner.login, "apple")
        XCTAssertEqual(responseObject.items[0].owner.avatarUrl, URL(string: "https://avatars.githubusercontent.com/u/10639145?v=4")!)
        XCTAssertEqual(responseObject.items[0].owner.htmlUrl, URL(string: "https://github.com/apple")!)
        XCTAssertEqual(responseObject.items[0].owner.type, "Organization")
    }
}
