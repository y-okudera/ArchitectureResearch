...
// MARK: - ApiResponse
public struct ApiResponse<T: Decodable & Equatable> {
...
extension ApiResponse: Equatable {
    public static func == (lhs: ApiResponse<T>, rhs: ApiResponse<T>) -> Bool {
        lhs.response == rhs.response && lhs.statusCode == rhs.statusCode && lhs.gitHubApiPagination == rhs.gitHubApiPagination
    }
}

// MARK: - GitHubApiPagination
public struct GitHubApiPagination: Equatable {
